...
class MoviesDataset(Dataset):
    ...
    def processed_file_names(self) -> str:
        # return ['/gpfsnyu/scratch/ny2208/jch/graphprompter/dataset-csv/Movies/Movies_graph_data.pt']
        # return ['/gpfsnyu/scratch/ny2208/jch/graphprompter/dataset-csv/Movies/Movies_structure_graph_data.pt']
        # return ['/gpfsnyu/scratch/ny2208/jch/graphprompter/dataset-csv/Movies/Movies_non_structure_graph_data.pt']
        # return ['/gpfsnyu/scratch/ny2208/jch/graphprompter/dataset-csv/Movies/Movies_textImage_graph_data.pt']
    
        # concat
        # return ['/gpfsnyu/scratch/ny2208/jch/graphprompter/dataset-csv/concat_embeddings/Movies_movie_ori_text_aug_imgText_graph_data.pt']
        return ['/gpfsnyu/scratch/ny2208/jch/graphprompter/dataset-csv/concat_embeddings/Movies_movie_ori_text_aug_imgText_ori_img_graph_data.pt']
    
    

    def get_idx_split(self):    
        json_path = "/gpfsnyu/scratch/ny2208/jch/graphprompter/dataset-csv/Movies/Movies_split.json"
